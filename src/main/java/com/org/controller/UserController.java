...
public class UserController {
    ...
    public String loginUser(@RequestBody String data ) {
    	Iterable<Users> users = userService.displayAllUser();
        for (Users other : users) {
//        	System.out.println(other.getUserEmail());
//        	System.out.println(data);
//        	System.out.println(data.contains(other.getUserEmail()));
            if (data.contains(other.getUserEmail())) 
            {
            	if(data.contains(other.getUserPassword())) {
            		return "Logged in successfully";
            	}

            }
        }
        return "Falied to Login";
    }
